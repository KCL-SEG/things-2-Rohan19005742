...
class ModelTest(TestCase):
    ...
    def test_name_may_have_35_characters(self):
        self.thing.name = 'x' * 35
        self._assert_thing_is_valid(message="Name may have 30 characters")

    def test_name_must_not_have_more_than_35_characters(self):
    ...
    def test_quantity_may_be_50(self):
        self.thing.quantity = 50
        self._assert_thing_is_valid(message="Quantity may be 100")

    def test_quantity_must_not_be_greater_than_50(self):
